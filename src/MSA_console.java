	...
	public static void main(String[] args) throws Exception{
		...
		*/	 
		...
		// System.exit(0);
		 ...
		 Pre_Cluster_process  cluster = new Pre_Cluster_process(local_path+"/MSA_OutPut", reduce_number);
		 ...
		 File delete_output = new File(local_path+"/MSA_OutPut");
		 ...
		 FileInputFormat.addInputPath(job_clustering, new Path(dfs_path+"/TheMSAFinaloutput/part-r-00000"));//mapreduce的输入目录位置
